...
public final class MessageServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "com.as.grpc.message.adapters.api.MessageService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.as.grpc.message.adapters.api.MessageRequest,
      com.as.grpc.message.adapters.api.MessageResponse> getEchoMessageMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "EchoMessage",
      requestType = com.as.grpc.message.adapters.api.MessageRequest.class,
      responseType = com.as.grpc.message.adapters.api.MessageResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.as.grpc.message.adapters.api.MessageRequest,
      com.as.grpc.message.adapters.api.MessageResponse> getEchoMessageMethod() {
    io.grpc.MethodDescriptor<com.as.grpc.message.adapters.api.MessageRequest, com.as.grpc.message.adapters.api.MessageResponse> getEchoMessageMethod;
      ...
      synchronized (MessageServiceGrpc.class) {
        if ((getEchoMessageMethod = MessageServiceGrpc.getEchoMessageMethod) == null) {
          MessageServiceGrpc.getEchoMessageMethod = getEchoMessageMethod =
              io.grpc.MethodDescriptor.<com.as.grpc.message.adapters.api.MessageRequest, com.as.grpc.message.adapters.api.MessageResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "EchoMessage"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.as.grpc.message.adapters.api.MessageRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.as.grpc.message.adapters.api.MessageResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void echoMessage(com.as.grpc.message.adapters.api.MessageRequest request,
        io.grpc.stub.StreamObserver<com.as.grpc.message.adapters.api.MessageResponse> responseObserver) {
  ...
  public static final class MessageServiceStub
    ...
    /**
     */
    public void echoMessage(com.as.grpc.message.adapters.api.MessageRequest request,
        io.grpc.stub.StreamObserver<com.as.grpc.message.adapters.api.MessageResponse> responseObserver) {
  ...
  public static final class MessageServiceBlockingStub
    ...
    /**
     */
    public com.as.grpc.message.adapters.api.MessageResponse echoMessage(com.as.grpc.message.adapters.api.MessageRequest request) {
  ...
  public static final class MessageServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.as.grpc.message.adapters.api.MessageResponse> echoMessage(
        com.as.grpc.message.adapters.api.MessageRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ECHO_MESSAGE:
          serviceImpl.echoMessage((com.as.grpc.message.adapters.api.MessageRequest) request,
              (io.grpc.stub.StreamObserver<com.as.grpc.message.adapters.api.MessageResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.as.grpc.message.adapters.api.MessageRequest,
              com.as.grpc.message.adapters.api.MessageResponse>(
  ...
  private static abstract class MessageServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.as.grpc.message.adapters.api.MessageServiceOuterClass.getDescriptor();
    }
